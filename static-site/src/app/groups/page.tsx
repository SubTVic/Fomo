...
export const metadata: Metadata = {
  title: "Alle Gruppen",
  description: "Stöbere durch alle verifizierten Hochschulgruppen der TU Dresden.",
};
  ...
  return (
    <div className="mx-auto w-full max-w-[1000px] px-4 py-8 sm:px-6">
      ...
      <p className="mt-2 max-w-prose text-body">
        {groups.length} verifizierte Hochschulgruppen der TU Dresden. Filtere nach Kategorie
