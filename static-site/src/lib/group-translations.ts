...
export const groupTranslations: Record<string, string> = {
  ...
  "aegee-dresden-e-v":
    "AEGEE-Dresden is the Dresden local chapter of the Europe-wide European Students' Forum. It promotes intercultural networking between German and international students, including through the buddy program, tandem partnerships, international exchanges and training events.",

  "aias-dresden-e-v":
    "AIAS Dresden e.V. is a student initiative at TU Dresden that has organized registration drives for potential stem cell donors in cooperation with DKMS since 2015 in order to help blood cancer patients. The group works on a volunteer basis to recruit as many students as possible as stem cell donors and has already achieved more than 7,300 registrations.",

  "aiesec-in-dresden":
    "AIESEC is a globally active, student-led organization that arranges intercultural exchange projects, internships and volunteering projects abroad. The Dresden local committee at TU Dresden supports young people's personal and professional development through leadership experience in an international environment.",

  "anw-hochschulgruppe-tharandt":
    "The ANW student group in Tharandt is a student group at TU Dresden's Tharandt campus with links to forest science and nature conservation, presumably active in applied natural sciences or forestry. Specific activities and orientation could not be verified.",

  "akademische-fliegergruppe-der-tu-dresden-e-v-akaflieg":
    "Akaflieg Dresden is a student group focused on building and developing gliders as well as gliding itself. Students independently develop and build aircraft while gaining practical knowledge in aerospace engineering.",

  "amateurfunk-an-der-tu-dresden-dl0tud":
    "The DARC local chapter TU Dresden (S07) operates the DL0TUD club station in TU Dresden's Barkhausen Building and practices amateur radio in all its facets. Activities include radio operation on shortwave and VHF/UHF, training for the amateur radio license, antenna construction and participation in national and international radio contests.",

  "amnesty-international-hochschulgruppe-dresden":
    "This student group volunteers for human rights by organizing petitions, urgent actions, information stands, workshops and events. In topic-specific subgroups, for example on women's rights, migration and anti-racism, students from all disciplines work on social and political issues.",
  ...
  "baghira":
    "Baghira is the student support group for the 'Balu und Du' mentoring program at TU Dresden, in which students volunteer as mentors for primary school children. The group organizes outreach, educational offers and events for the program and works for equal educational opportunities.",
  ...
  "campusradio-dresden-e-v":
    "Campusradio Dresden e.V. is a student-run internet radio station across universities, produced by students for students. Members create podcasts, shows and contributions on campus life, culture, music and society, with no prior radio experience required.",

  "christians-for-mission":
    "Christians for Mission is a Christian student group at TU Dresden that brings together students from different backgrounds to discuss the Christian faith, read the Bible and experience community.",

  "club-11-e-v":
    "Club 11 e.V. is a volunteer student club at TU Dresden on Hochschulstraße 48. It runs a bar and regularly organizes events such as parties, band nights, quiz nights and the traditional Bockbier tapping. The association is run by students for students and invites people to get involved, work bar shifts and help plan events.",
  ...
  "de-latam-e-v":
    "DE-LATAM e.V. is a Latin American student group at TU Dresden that connects students from Latin America with interested students. It is active in language, sports, leisure, intercultural exchange, arts and culture as well as academic events.",

  "dgb-hochschulgruppe-dresden":
    "The DGB student group Dresden is the trade-union student group at TU Dresden and HTW Dresden. It gets involved in university politics, participation, study conditions and working conditions. It also offers regular advising for students on employee rights, insurance and taxes.",
  ...
  "die-buehne-e-v-das-theater-der-tu-dresden":
  ...
  "die-linke-sds-dresden":
    "DIE LINKE.SDS Dresden is the Dresden local group of the Socialist-Democratic Student Association. It is mainly active at TU Dresden and meets weekly to discuss current political topics, continue political education and organize left-wing activism. The group works against the shift to the right, neoliberalism and social injustice, and is active in areas such as anti-fascism, feminism and climate policy.",
  ...
  "euroavia-dresden-e-v":
    "EUROAVIA Dresden is a student association for people interested in aerospace at TU Dresden. As part of the European EUROAVIA network, it promotes exchange between students, companies and universities through excursions, workshops, lectures and international events.",
  ...
  "elbe-model-united-nations-e-v-elbmun":
    "elbMUN is a student group at TU Dresden that has organized a multi-day international UN simulation conference, Model United Nations, every year since 2010 in the Saxon State Parliament. Around 80 to 150 students from around the world debate current global political issues in simulated UN bodies in English.",
  ...
  "evangelische-studierendengemeinde-dresden-esg":
    "ESG Dresden is a Protestant student group at TU Dresden. It organizes weekly community evenings with devotion, dinner and lectures on social, church-related and academic topics. It also offers small groups, a brass choir, church services and community weekends for students.",
  ...
  "fridays-for-future-dresden":
    "Fridays for Future Dresden is a climate protection movement that brings together school students, university students, trainees and other people from Dresden who take to the streets for climate justice and immediate action against the climate crisis. The group organizes regular climate strikes and demonstrations as well as a weekly plenum.",
  ...
  "hsg-grundvorlesung-oekologische-nachhaltigkeit":
  ...
  "indian-association-dresden-e-v":
    "Indian Association Dresden e.V. (IAD) is a non-profit association of Indian students, professionals and families in Dresden. It promotes Indian culture and supports Indian students and professionals with integration. It organizes regular meetups, cultural events, workshops and film evenings for the Indian community and everyone in Dresden interested in Indian culture.",

  "ingenieure-ohne-grenzen-dresden-iog":
    "The Dresden regional group of Engineers Without Borders Germany volunteers in development cooperation and works on projects in water and energy supply, educational facilities and civil infrastructure in the Global South. Around 30 active members meet several times a month to discuss and implement ongoing projects, such as Mbuyuni Sunrise Academy in Kenya.",

  "interessengemeinschaft-boerse-an-der-tu-dresden-e-v":
  ...
  "islamischer-hochschulbund-dresden":
    "The Islamic Student Association Dresden is a student group at TU Dresden founded by Muslim students and academics. It promotes the Islamic religion, interreligious dialogue, international networking and the social integration of Muslim students.",

  "juforum-lokalgruppe-dresden":
    "The JuFORUM local group Dresden is the Dresden chapter of the German young researchers' network juFORUM e.V., a nationwide STEM network for students, school students and doctoral candidates interested in science and technology. The group organizes local meetups, science pubs, excursions to research institutions and connects STEM-enthusiastic young people in the region.",
  ...
  "juso-hochschulgruppe-jhg-dresden":
    "JHG Dresden is the Young Socialist student association at TU Dresden and works for open, democratic and modern university politics. As part of the Jusos and the SPD, it is politically and socially committed to progressive university and social policy.",

  "kreta-kritische-einfuehrungstage":
    "KRETA organizes critical introductory days at TU Dresden with lectures, workshops and discussions on political and social topics. Its goal is to give new students and other interested people an entry point into critical social thinking and activism in Dresden.",

  "kammerchor-cantabile-dresden":
    "Kammerchor Cantabile Dresden is an a cappella chamber choir that emerged from the University Orchestra Dresden in 2023. Under the direction of Johannes Radde, it performs sacred and secular classical choral music from different eras. Members rehearse weekly and perform in concerts and on tours.",

  "kellerklub-gag-18-e-v":
    "Kellerklub GAG 18 e.V. is a student club at TU Dresden that has existed since 1974. Located in a vaulted basement, it offers alternative parties every Friday, including gothic, metal, EBM and punk rock, as well as pub nights, regular meetups and game nights during the week. The association is organized on a volunteer basis by its members and promotes student culture at affordable prices.",

  "kino-im-kasten":
    "Kino im Kasten (KiK) is a non-commercial repertory cinema run by TU Dresden students on a volunteer basis since 1993. It shows films of all genres and eras on the big screen. In addition to the regular semester program, the group organizes special events such as silent-film evenings with live music, an outdoor summer cinema on campus and opportunities for members to help shape programming, cinema technology and public relations.",

  "kultur-in-der-neuen-mensa":
    "Kultur in der Neuen Mensa e.V. (KNM) is a student cultural association at TU Dresden, founded in December 2024 to bring a varied cultural program to the beer bar, foyer and halls of the reopened Neue Mensa. The program includes parties, concerts, open-stage evenings, cabaret, cinema and other events for students.",
  ...
  "medinetz-dresden-e-v":
    "MediNetz Dresden e.V. is a human-rights initiative of students and doctors that anonymously and free of charge arranges medical help for refugees and people without residence status in Dresden. The association also campaigns politically for comprehensive healthcare for people without papers.",

  "mit-sicherheit-verliebt-lokalgruppe-dresden":
    "Mit Sicherheit Verliebt (MSV) is a student group that uses a peer-education approach to run sex-positive education workshops in schools for grades 6 to 10. Topics include sexuality, contraception, STIs, body image and tolerance. The group is part of the nationwide bvmd project and meets every two weeks for organization and internal training.",

  "nachhaltigkeits-ag-bauwesen-der-tu-dresden-e-v":
    "The Sustainability Working Group in Civil Engineering is a student group and registered association at TU Dresden that has worked for more sustainable teaching and construction practices since 2021. It focuses on alternative building materials, resource conservation and a sustainable transformation of construction through excursions, workshops, regular meetings and participation in shaping university teaching.",
  ...
  "paul-consultants-e-v":
    "PAUL Consultants is TU Dresden's student consultancy, founded in 1996 and experienced in more than 450 projects. Students from all disciplines jointly advise companies from different industries and gain practical consulting experience.",

  "pakistan-student-association-psa-dresden":
    "Pakistan Student Association Dresden is a student organization at TU Dresden that connects Pakistani and international students, supports integration and helps students settle into life in Dresden. It promotes cultural exchange and organizes community and cultural events.",
  ...
  "rock-your-life-dresden-e-v":
    "Rock Your Life! Dresden e.V. is a student group at TU Dresden that works for educational justice. It brings together young people from disadvantaged families aged 14 to 18 with university students as mentors through a free one-to-one mentoring program called R!EACH. The goal is to help young people with school-related challenges, career orientation and the development of their individual potential.",
  ...
  "star-dresden-e-v":
    "STAR Dresden, the Student Space Working Group Dresden, is a student group at TU Dresden that offers students from all disciplines a platform to engage practically with space-related topics. The association develops Mars rovers, CanSats and rocket experiments and takes part in international competitions such as the European Rover Challenge and the REXUS/BEXUS program.",
  ...
  "studentenclub-baerenzwinger-e-v":
    "Studentenclub Bärenzwinger is one of Dresden's oldest and best-known student cultural and meeting centers. Located in historic vaults beneath the Brühlsche Terrasse, it hosts parties, concerts, theatre, cabaret, readings and bar evenings. The non-profit association combines a student pub with a broad cultural program and is open to students and the Dresden public.",

  "studentenreiter-dresden":
    "Studentenreiter Dresden is a student group of horse-loving students from Dresden and the surrounding area. They are organized in the German Academic Equestrian Association and take part in university riding tournaments. In addition to active equestrian sport, they offer many community activities within the Germany-wide Studentenreiter community.",

  "studentische-arbeitsvermittlung-dresden-stav-e-v":
    "STAV e.V. is a student-organized job placement service at TU Dresden that connects students with part-time jobs, working-student positions and temporary jobs. It runs an office on campus and offers a job-placement platform for students, companies and private individuals.",
  ...
  "studentischer-sanitaetsdienst-der-tu-dresden":
  ...
  "studis-gegen-rechts-dresden":
    "Studis gegen Rechts is a student initiative at TU Dresden that works against the shift to the right and misanthropic positions. It invites all students to get involved regardless of previous political experience. The group organizes lectures, open meetings, demonstrations and networking events to promote anti-fascist engagement at the university.",

  "studytutors-dresden":
    "Studytutors Dresden is the Dresden location of the nationwide association StudyTutors e.V., where students volunteer to provide free tutoring for financially disadvantaged school students. The location cooperates with organizations such as Diakonie, Dresdner Treberhilfe and the Kinder- und Jugendhaus INSEL and is supported by more than 30 committed students.",

  "stutentenclub-borsi-34-e-v":
    "Studentenclub Borsi 34 e.V. is a student club that has existed since 1985 in the basement of the Borsbergstraße 34 residence hall in Dresden-Striesen. It is run by students for students and offers weekly evenings with a bar, parties, concerts, basement quizzes and other events.",
  ...
  "tu-dresden-robotik-ag-turag":
    "TURAG is a student robotics working group at TU Dresden that designs and builds autonomous robots in order to gain practical engineering experience. Each year, the group takes part in the international Eurobot competition and presents its projects at various events.",

  "technische-universitaet-dresden-robotik-arbeitsgruppe":
  ...
  "therapie-mal-anders":
    "Therapie mal anders is an event series by the Critical Psychology student group at TU Dresden. Organized by psychology students, it explores topics from psychology and psychotherapy in a social and political context that do not have a place in the regular curriculum. Focus areas include discrimination, racism, classism and gender in psychotherapeutic settings.",

  "traumtaenzer-e-v":
    "Traumtänzer e.V. is a student medieval-themed club in Dresden's Südvorstadt that runs a role-playing, medieval and cocktail bar with a rustic design. In addition to regular bar service, the club offers events such as pen-and-paper meetups, board-game cafés, karaoke, theme parties and the traditional medieval festival.",

  "universitaetsorchester-dresden":
    "Universitätsorchester Dresden brings together more than 100 members in two symphonic and chamber-philharmonic ensembles, mainly TU Dresden students, employees and alumni. They rehearse classical orchestral music together every week. At the end of each semester, both ensembles present themselves in concerts at a recognized high level.",
  ...
  "verkehrte-welt-e-v":
    "Verkehrte Welt e.V. is a student association at TU Dresden that connects students of transport sciences and other interested people internationally. The association organizes international study trips, excursions, conferences and lecture series on transport and railway systems.",

  "volt-hochschulgruppe-dresden":
    "The Volt student group Dresden is the student group of the pan-European party Volt at TU Dresden. It advocates the European idea, leads political debates on campus and networks across Europe.",
  ...
  "altbau-e-v-alumniverein-bauingenieurwesen-tu-dresden":
    "altBau e.V. is a non-profit alumni association made up of current and former students of TU Dresden's Faculty of Civil Engineering. It focuses on networking within the faculty, especially alumni networking, a graduation ball and a construction-specific company contact fair.",
  ...
  "bts-life-sciences-studierendeninitiative-e-v":
    "btS is a non-profit student initiative that helps students and doctoral candidates in the life sciences, including biology, biochemistry, biotechnology and pharmacy, enter professional life through lectures, excursions, workshops and career fairs. At TU Dresden, the group works closely with research institutes and companies to open up career and networking opportunities in the life-sciences field.",

  "genow-gender-equality-now":
    "genow. is a student group at TU Dresden founded by students in 2019 that works for gender equality. The group organizes lecture series, workshops and panel discussions on topics such as gender-based violence, feminism and anti-discrimination.",

  "jdpg-dresden":
    "jDPG Dresden is the regional group of the young German Physical Society at TU Dresden. It inspires students for physics through lecture evenings, excursions, 'Meet your Prof' events and meetings for new members. Its goal is to connect young physicists, provide insights into modern research and highlight career perspectives.",

  "junge-gew-gew-hochschulgruppe-dresden":
    "junge GEW is the student group of the Education and Science Workers' Union (GEW) at TU Dresden. It works on educational and social policy issues, better study conditions and a collective agreement for student employees. The group meets monthly to discuss union topics and be politically active.",

  "kritmed":
    "kritmed* is a student group at the student council for medicine and dentistry at TU Dresden. It critically engages with medical-political topics and university teaching at Dresden University Hospital. The group organizes lecture series on topics such as discrimination, queerness and health justice and has been recognized for diversity-sensitive teaching.",

  "kritmed-dresden":
    "kritmed* is a student group at the student council for medicine and dentistry at TU Dresden. It critically engages with medical-political topics, discrimination in healthcare and social-political questions of university teaching at the university hospital. The group organizes lecture series, workshops and events on topics such as reproductive rights, diversity in medicine and health policy.",
};
